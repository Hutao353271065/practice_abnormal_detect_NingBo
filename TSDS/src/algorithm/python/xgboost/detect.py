...
if __name__ == "__main__":
    ...
    #     data_path = argv[1]
    #     data_name =argv[2]
    #     model_name = MODEL_PATH + argv[3]

    # 2、读取文件
    start=time.time()
    data = pd.read_csv('/Users/huangchuang/Downloads/test2.csv')
    data = data[0:10000]
    data['label'] = 0
    # 3、数据预处理 + 特征提取
    ...
    #imgName = 'res_xgb.png'
    # imgName='xgboost_results.png'
    #imgPath = './output/'
    # imgPath='/Users/huangchuang/Downloads/'
    # plt.savefig(imgPath + imgName)
    # plt.show()

    # result.to_csv("./output/ret.csv", index=0)
